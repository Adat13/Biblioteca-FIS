<div>
    ...
    <div wire:ignore.self class="modal fade" id="subirCSV" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document"
            style="display: flex; max-width: 90%; width: auto;">
            <div class="modal-content" style="max-height: 97vh; overflow-y: auto;">
                <div class="modal-header">
                    <h5 class="modal-title">Subir Libros mediante .CSV</h5>
                ...
                <div class="modal-footer">
                    @if ($csvData)
                        ...
                        <button type="button" wire:click="discardChanges" class="btn btn-warning">Descartar Cambios</button>
                        <button type="button" wire:click="save" class="btn btn-primary">Guardar en Base de Datos</button>
                    @endif
